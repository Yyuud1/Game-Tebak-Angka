 ...
 //   tambahkan sebuah event listener "load" pada objek window. Sehingga, ketika berkas HTML sudah selesai ditampilkan, kita akan mengecek apakah item pada session storage maupun local storage sudah dibuat atau belum
